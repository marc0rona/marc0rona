/* Afficher tous les tableaux a l'ouverture */
...
function MenuSelect() 
{
    ...
    itemID2.innerHTML += Biblio.LivreID[14];
    let itemTitre2 = document.getElementById("2.titres");
    itemTitre2.textContent = Biblio.Titres[14];
    let itemAuteur2 = document.getElementById("2.auteur");
    itemAuteur2.textContent = Biblio.Auteurs[14];
    let itemPublic2 = document.getElementById("2.pub");
    itemPublic2.textContent = Biblio.Publication[14];
    let itemPages2 = document.getElementById("2.pages");
    itemPages2.textContent = Biblio.Pages[14];
    let itemGenre2 = document.getElementById("2.genre");
    itemGenre2.textContent = Biblio.Genre[14];

    let itemDesc2 = document.getElementById("2.desc");
    itemDesc2.textContent = Biblio.Description[14];
}
